...
export interface CandidateResume { id:string; originalFilename:string; uploadedAt:string; parsedAt:string|null; parsingStatus:"uploaded"|"parsing"|"parsed"|"failed"; parsingError:string|null; }
