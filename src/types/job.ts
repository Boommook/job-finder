...
export interface JobPreferences { desiredTitles:string[]; desiredLocations:string[]; allowUsRemote?:boolean; remotePreference:WorkArrangement|"flexible"; employmentTypes:EmploymentType[]; minimumSalary:number|null; preferredIndustries:string[]; preferredSkills:string[]; excludedKeywords:string[]; sponsorshipRequired:boolean; }
