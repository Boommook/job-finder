...
export interface Job { id:string; externalId?:string; source?:string; company:string; title:string; category:string; location:string; workArrangement?:WorkArrangement; employmentType?:EmploymentType; description:string; salaryMin?:number; salaryMax?:number; salaryCurrency?:string; skills?:string[]; seniority?:string; sponsorship?:boolean; postedAt?:string; discoveredAt:string; sourceUrl:string; applyUrl?:string; status:JobStatus; evaluation?:JobEvaluation; }
